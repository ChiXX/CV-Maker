      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-xl shadow-black/5 p-8 md:p-12 space-y-10">
        <div className="space-y-2">
          ...
          <p className="text-zinc-500 dark:text-zinc-400">
            Creating a customized CV for the <span className="text-zinc-900 dark:text-white font-bold">{data.extractedData?.title}</span> position
          </p>
        </div>
        ...
        {activePdfBlob && currentStep === 'complete' && (
          <div className="space-y-6 animate-in fade-in zoom-in-95 duration-700">
            <div className="flex justify-between items-center px-1">
              <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Generated CV</h3>
